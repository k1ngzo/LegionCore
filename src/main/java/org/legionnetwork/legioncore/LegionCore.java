package org.legionnetwork.legioncore;
 ...
 */
public final class LegionCore extends SimplePlugin {
	...
	*/
	 ...
	 * @return
	 */
	public static LegionCore getInstance() {
		return (LegionCore) SimplePlugin.getInstance();
	}
}
